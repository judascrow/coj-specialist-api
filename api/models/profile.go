...
type Profile struct {
	...
	FileAttachIdcard        string     `json:"fileAttachIdcard" form:"fileAttachIdcard"`
	FileAttachHouse         string     `json:"fileAttachHouse" form:"fileAttachHouse"`
	FileAttachGovCard       string     `json:"fileAttachGovCard" form:"fileAttachGovCard"`
	FileAttachQualification string     `json:"fileAttachQualification" form:"fileAttachQualification"`
